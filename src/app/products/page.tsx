...
const airSnapSpecs: SpecSection[] = [
  {
    icon: "✈️",
    title: {
...
const travelFlySpecs: SpecSection[] = [
  {
    icon: "🔋",
    title: {
      cs: "Výkon a vytrvalost",
      en: "Performance and Endurance",
    },
    items: [
      {
        label: { cs: "Vzletová hmotnost", en: "Take-off weight" },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: { cs: "Rozlišení videa", en: "Video resolution" },
        value: {
          cs: "1080p Full HD při 30 fps",
          en: "1080p Full HD at 30 fps",
        },
      },
      {
        label: { cs: "Rozlišení foto", en: "Photo resolution" },
...
const inspectSpecs: SpecSection[] = [
  {
    icon: "✈️",
    title: {
      cs: "Letové vlastnosti a konstrukce",
    ...
    items: [
      ...
      },
      {
        label: { cs: "Max. doba letu", en: "Max. flight time" },
        value: {
          cs: "42 minut (se zátěží)",
          en: "42 minutes (under load)",
        },
      },
      {
        label: { cs: "Max. rychlost", en: "Max. speed" },
      ...
      },
      {
        label: { cs: "Odolnost větru", en: "Wind resistance" },
        value: {
          cs: "15 m/s (extrémní odolnost)",
          en: "15 m/s (extreme resistance)",
        },
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: { cs: "Interní úložiště", en: "Internal storage" },
        value: {
          cs: "128 GB (šifrování AES-256)",
          en: "128 GB (AES-256 encryption)",
        },
      },
      {
...
const agroScanSpecs: SpecSection[] = [
  {
    icon: "✈️",
    title: {
      cs: "Letové vlastnosti a konstrukce",
...
const rescueEyeSpecs: SpecSection[] = [
  {
    icon: "✈️",
    title: {
      cs: "Letové vlastnosti a konstrukce",
...
const medDropSpecs: SpecSection[] = [
  {
    icon: "✈️",
    title: {
      cs: "Letové vlastnosti a pohon",
      en: "Flight Properties and Propulsion",
    },
    items: [
      {
        label: { cs: "Vzletová hmotnost", en: "Take-off weight" },
      ...
      },
      {
        label: { cs: "Max. doba letu", en: "Max. flight time" },
        value: {
          cs: "40 minut (plně naložený)",
          en: "40 minutes (fully loaded)",
        },
      },
      {
        label: { cs: "Max. rychlost", en: "Max. speed" },
      ...
      },
      {
        label: { cs: "Odolnost větru", en: "Wind resistance" },
        value: {
          cs: "17 m/s (Level 8 – extrémní)",
          en: "17 m/s (Level 8 – extreme)",
        },
      },
      {
        label: { cs: "Krytí", en: "Protection rating" },
...
const vortexSpecs: SpecSection[] = [
  {
    icon: "✈️",
    title: {
      cs: "Konstrukce a výkon",
      en: "Build and Performance",
    },
    items: [
      {
        label: { cs: "Vzletová hmotnost", en: "Take-off weight" },
...
const falconSpecs: SpecSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        label: { cs: "Motory", en: "Motors" },
        value: {
          cs: "REGEN Eco 1404 (3800 KV)",
          en: "REGEN Eco 1404 (3800 KV)",
        },
      },
      {
        label: { cs: "Řídicí jednotka", en: "Flight controller" },
      ...
      },
      {
        label: { cs: "Krytí", en: "Protection rating" },
        value: {
          cs: "IP33 – základní ochrana proti prachu",
          en: "IP33 – basic dust protection",
        },
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        label: { cs: "Max. dosah", en: "Max. range" },
        value: {
          cs: "2 km (stabilní analogový signál)",
          en: "2 km (stable analog signal)",
        },
      },
      {
        label: { cs: "Max. doba letu", en: "Max. flight time" },
...
const skybridgerSpecs: SpecSection[] = [
  {
    icon: "✈️",
    ...
    items: [
      ...
      },
      {
        ...
        value: {
          cs: "85 km/h (max. 110 km/h)",
          en: "85 km/h (max. 110 km/h)",
        },
      },
      {
        label: { cs: "Max. doba letu", en: "Max. flight time" },
        value: {
          cs: "150 minut (2,5 hodiny)",
          en: "150 minutes (2.5 hours)",
        },
      },
      {
        label: { cs: "Odolnost větru", en: "Wind resistance" },
...
const skydiverSpecs: SpecSection[] = [
  {
    icon: "✈️",
    title: { cs: "Konstrukce a výkon", en: "Build and Performance" },
    items: [
      ...
      },
      {
        label: { cs: "Krytí", en: "Protection rating" },
        value: {
          cs: "IP40 – základní ochrana",
          en: "IP40 – basic protection",
        },
      },
    ],
  },
...
const sentinelSpecs: SpecSection[] = [
  {
    icon: "✈️",
    title: { cs: "Konstrukce a letové vlastnosti", en: "Build and Flight Properties" },
    items: [
      ...
      },
      {
        label: { cs: "Max. doba letu", en: "Max. flight time" },
        value: {
          cs: "70 minut (duální bateriový systém)",
          en: "70 minutes (dual battery system)",
        },
      },
      {
        label: { cs: "Max. rychlost", en: "Max. speed" },
...
const guardianSpecs: SpecSection[] = [
  {
    icon: "✈️",
    title: { cs: "Konstrukce a letové vlastnosti", en: "Build and Flight Properties" },
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: { cs: "Interní úložiště", en: "Internal storage" },
        value: {
          cs: "1 TB – zabezpečený SSD modul",
          en: "1 TB – secure SSD module",
        },
      },
      {
...
const weightlifterSpecs: SpecSection[] = [
  {
    icon: "✈️",
    title: { cs: "Konstrukce a letové vlastnosti", en: "Build and Flight Properties" },
    items: [
      {
        label: { cs: "Kategorie (EU)", en: "EU Category" },
        value: {
          cs: "Specific / C6 (těžký transport)",
          en: "Specific / C6 (heavy transport)",
        },
      },
      {
        label: { cs: "Konstrukce", en: "Airframe" },
      ...
      },
      {
        label: { cs: "Vzletová hmotnost", en: "Take-off weight" },
        value: {
          cs: "22 500 g (bez nákladu)",
          en: "22,500 g (without payload)",
        },
      },
      {
      ...
      },
      {
        label: { cs: "Krytí", en: "Protection rating" },
        value: {
          cs: "IP54 – prach a stříkající voda",
          en: "IP54 – dust and splashing water",
        },
      },
    ],
  },
    ...
    items: [
      {
        label: { cs: "Užitečné zatížení", en: "Payload capacity" },
        value: {
          cs: "až 25 kg (čistá váha nákladu)",
          en: "up to 25 kg (net payload weight)",
        },
      },
      {
...
const promoFleetSpecs: SpecSection[] = [
  {
    icon: "✈️",
    title: { cs: "Konstrukce a letové vlastnosti", en: "Build and Flight Properties" },
    items: [
      ...
      },
      {
        label: { cs: "Max. doba letu", en: "Max. flight time" },
        value: {
          cs: "22 minut (čistý čas pro show)",
          en: "22 minutes (clean show time)",
        },
      },
      {
        label: { cs: "Odolnost větru", en: "Wind resistance" },
...
function SpecModal({
  ...
  language: Language;
  onClose: () => void;
  copy: { close: string; specsComingSoon: string; technicalSpec: string };
}) {
  useEffect(() => {
